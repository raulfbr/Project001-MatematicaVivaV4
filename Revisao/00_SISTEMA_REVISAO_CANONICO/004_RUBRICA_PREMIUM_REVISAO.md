...
## 1) Missao desta rubrica
Esta rubrica existe para transformar "impecavel" em criterio objetivo.
...
1. `0` = reprovado
2. `1` = muito fraco
3. `2` = funcional mas abaixo do premium
4. `3` = bom
5. `4` = muito bom
6. `5` = premium
...
## 3) Eixo 1 - Estrutura
Pergunta central:
1. a licao esta arquitetonicamente inteira e coerente?

Criticos:
1. secoes obrigatorias presentes;
2. ordem correta;
...
2. `1`: varias secoes ausentes ou fora de ordem
3. `2`: funcional, mas com faltas importantes
4. `3`: correta com pequenas arestas
5. `4`: solida e consistente
6. `5`: canonica, limpa e sem friccao

---

## 4) Eixo 2 - Narrativa
Pergunta central:
1. a licao imerge e sustenta o Reino com dignidade?

Criticos:
1. local revelado no Ritual;
2. guardiao apresentado na Jornada;
...
2. `1`: fria, mecanica ou condescendente
3. `2`: funcional, mas sem brilho
4. `3`: boa e coerente
5. `4`: muito envolvente
6. `5`: imersiva, memoravel e premium

---

## 5) Eixo 3 - Pedagogia
Pergunta central:
1. a crianca vive matematica real, concreta e apropriada?

Criticos:
1. concreto domina;
2. objetivo da licao esta claro;
...
Guia de nota:
1. `0`: pedagogia falha
2. `1`: excesso de abstracao ou atividade frouxa
3. `2`: objetivo existe, mas mal encarnado
4. `3`: boa base concreta
5. `4`: forte e aplicavel
6. `5`: profunda, pratica e elegante

---

## 6) Eixo 4 - UX do Portador
Pergunta central:
1. o pai/mae consegue aplicar com leveza e clareza no celular?

Criticos:
1. texto escaneavel;
2. instrucoes acionaveis;
...
Guia de nota:
1. `0`: friccao alta
2. `1`: cansativo ou confuso
3. `2`: utilizavel, mas pesado
4. `3`: bom
5. `4`: muito claro e confortavel
6. `5`: simples, elegante e pronto para usar
...
1. familia no centro;
2. tom redentor;
3. dignidade da crianca;
4. identidade recognoscivel;
5. beleza redentora;
6. convite em vez de imposicao.

Guia de nota:
1. `0`: trai o North Star
2. `1`: pouco fiel, tom ou experiencia errados
