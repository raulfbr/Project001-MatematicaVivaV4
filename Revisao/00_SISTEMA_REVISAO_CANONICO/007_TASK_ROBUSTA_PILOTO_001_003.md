...
9. `Revisao/00_SISTEMA_REVISAO_CANONICO/011_TOPICOS/`
10. `Revisao/00_SISTEMA_REVISAO_CANONICO/012_TRANSVERSAIS/`
...
Modelo por licao:
1. `001_BASE_E_HERO` -> cobre / cobre parcial / nao cobre
2. `002_HEADER_SUPERIOR` -> cobre / cobre parcial / nao cobre
3. `003_PREPARACAO_DO_PORTADOR` -> cobre / cobre parcial / nao cobre
4. `004_RITUAL_DE_ENTRADA` -> cobre / cobre parcial / nao cobre
5. `005_A_JORNADA` -> cobre / cobre parcial / nao cobre
6. `006_MOMENTO_DE_CONEXAO` -> cobre / cobre parcial / nao cobre
7. `007_NARRAMOS_JUNTOS` -> cobre / cobre parcial / nao cobre
8. `008_RITUAL_DE_FECHAMENTO` -> cobre / cobre parcial / nao cobre
9. `009_CONEXAO_DA_JORNADA` -> cobre / cobre parcial / nao cobre
10. `010_SEMENTES_PARA_O_DIA` -> cobre / cobre parcial / nao cobre
11. `011_FORMACAO_DO_PORTADOR` -> cobre / cobre parcial / nao cobre
12. `012_NAVEGACAO_INFERIOR` -> cobre / cobre parcial / nao cobre
...
- 001_BASE_E_HERO:
- 002_HEADER_SUPERIOR:
- 003_PREPARACAO_DO_PORTADOR:
- 004_RITUAL_DE_ENTRADA:
- 005_A_JORNADA:
- 006_MOMENTO_DE_CONEXAO:
- 007_NARRAMOS_JUNTOS:
- 008_RITUAL_DE_FECHAMENTO:
- 009_CONEXAO_DA_JORNADA:
- 010_SEMENTES_PARA_O_DIA:
- 011_FORMACAO_DO_PORTADOR:
- 012_NAVEGACAO_INFERIOR:
