...
Use a pasta assim:
1. leia os topicos na ordem oficial;
2. confira o HTML real da licao;
3. registre gaps de cobertura, naming e estrutura;
4. trate divergencia entre topico e HTML como finding de revisao.
