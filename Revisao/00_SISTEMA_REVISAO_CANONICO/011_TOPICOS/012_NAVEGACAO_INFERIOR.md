...
`Revise a Navegacao Inferior validando lesson-nav, prev/next, labels, titulos e footer; trate qualquer divergencia com o Header Superior como bloqueio estrutural.`
