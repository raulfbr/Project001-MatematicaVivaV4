...
Status: canonico
Escopo: `MV-S-001+`
Excecao formal: `MV-S-000` (ver `Revisao/transversais/TX07_EXCECAO_L000_PORTAL.md`)
...
Referencia:
1. `Revisao/topicos/01_HEADER_SUPERIOR.md`
...
Referencia:
1. `Revisao/topicos/02_PREPARACAO_DO_PORTADOR.md`
...
Referencia:
1. `Revisao/topicos/03_RITUAL_DE_ENTRADA.md`
...
Referencia:
1. `Revisao/topicos/04_A_JORNADA.md`
...
Referencia:
1. `Revisao/topicos/05_MOMENTO_DE_CONEXAO.md`
...
Referencia:
1. `Revisao/topicos/06_NARRAMOS_JUNTOS.md`
...
Referencia:
1. `Revisao/topicos/07_RITUAL_DE_FECHAMENTO.md`
...
Referencia:
1. `Revisao/topicos/08_CONEXAO_DA_JORNADA.md`
...
Referencia:
1. `Revisao/topicos/09_SEMENTES_PARA_O_DIA.md`
...
Referencia:
1. `Revisao/topicos/10_FORMACAO_DO_PORTADOR.md`
...
Referencia:
1. `Revisao/topicos/11_NAVEGACAO_INFERIOR.md`
...
Arquivos centrais:
1. `Revisao/PROTOCOLO_REVISAO_POR_LICAO.md`
2. `Revisao/RUBRICA_PREMIUM_REVISAO.md`
3. `Revisao/STATUS_REVISAO_SEMENTES.md`
...
8. `Revisao/transversais/TX08_NORTH_STAR_OPERACIONAL.md`
