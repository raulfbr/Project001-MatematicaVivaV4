...
Base imediata: `Revisao/ESQUELETO_GERAL_PLANO_PROXIMA_SESSAO.md`
...
Executado:
1. `ESQUELETO_GERAL_LICAO_SEMENTES.md`
2. `PROTOCOLO_REVISAO_POR_LICAO.md`
3. `RUBRICA_PREMIUM_REVISAO.md`
4. `STATUS_REVISAO_SEMENTES.md`
5. pasta `Revisao/topicos/` com 12 guias
6. pasta `Revisao/transversais/` com 7 regras
...
1. `Revisao/padrao_visual_sementes.md` esta forte, mas concentra contrato estrutural, regras de escrita, iconografia, anti-patterns e filosofia em um unico documento.
2. `Revisao/topicos_licao_revisao.md` ainda preserva exemplos legados e trechos que conflitam com o padrao alvo.
3. `Revisao/ESQUELETO_GERAL_PLANO_PROXIMA_SESSAO.md` define a intencao, mas ainda nao define o sistema operacional final.
...
6. Ainda nao existe um protocolo diario de revisao que permita executar rapido sem reabrir todo o contexto do projeto.
...
6. `Revisao/ESQUELETO_GERAL_PLANO_PROXIMA_SESSAO.md`
...
1. `Revisao/ESQUELETO_GERAL_LICAO_SEMENTES.md`
2. `Revisao/PROTOCOLO_REVISAO_POR_LICAO.md`
3. `Revisao/RUBRICA_PREMIUM_REVISAO.md`
4. `Revisao/STATUS_REVISAO_SEMENTES.md`
5. Pasta `Revisao/topicos/`
6. Pasta `Revisao/transversais/`
...
1. `Revisao/topicos/00_BASE_E_HERO.md`
2. `Revisao/topicos/01_HEADER_SUPERIOR.md`
3. `Revisao/topicos/02_PREPARACAO_DO_PORTADOR.md`
4. `Revisao/topicos/03_RITUAL_DE_ENTRADA.md`
5. `Revisao/topicos/04_A_JORNADA.md`
6. `Revisao/topicos/05_MOMENTO_DE_CONEXAO.md`
7. `Revisao/topicos/06_NARRAMOS_JUNTOS.md`
8. `Revisao/topicos/07_RITUAL_DE_FECHAMENTO.md`
9. `Revisao/topicos/08_CONEXAO_DA_JORNADA.md`
10. `Revisao/topicos/09_SEMENTES_PARA_O_DIA.md`
11. `Revisao/topicos/10_FORMACAO_DO_PORTADOR.md`
12. `Revisao/topicos/11_NAVEGACAO_INFERIOR.md`

### 7.3 Pasta de regras transversais
Proposta de arquivos:

1. `Revisao/transversais/TX01_ICONES_CORES_E_ASSETS.md`
2. `Revisao/transversais/TX02_REGRAS_DE_HTML_E_ANTI_PATTERNS.md`
3. `Revisao/transversais/TX03_TOM_NARRATIVO_E_DIRECAO_DO_PORTADOR.md`
4. `Revisao/transversais/TX04_GUARDIOES_CARDS_E_REVEAL.md`
5. `Revisao/transversais/TX05_CRITERIOS_PEDAGOGICOS_CM_CPA_TGTB.md`
6. `Revisao/transversais/TX06_ENCODING_E_SANITY_CHECK.md`
7. `Revisao/transversais/TX07_EXCECAO_L000_PORTAL.md`

---

## 8) Contrato obrigatorio de cada arquivo de topico
Cada arquivo em `Revisao/topicos/` deve seguir a mesma anatomia:
...
7. Checklist PASS/FAIL
   - lista objetiva que a IA ou humano consegue marcar sem interpretacao nebulosa.

8. Prompt operacional para IA
   - instrucoes curtas para revisar ou reescrever so aquele topico sem contaminar o resto.

9. Exemplo canonico
   - snippet ou mini exemplo aprovado, quando isso reduzir ambiguidade.

---

## 9) Contrato obrigatorio dos arquivos transversais
Cada arquivo em `Revisao/transversais/` deve resolver uma familia de decisoes que afeta varios topicos.
...
1. `00_BASE_E_HERO`
2. `01_HEADER_SUPERIOR`
3. `02_PREPARACAO_DO_PORTADOR`
4. `03_RITUAL_DE_ENTRADA`
5. `04_A_JORNADA`
6. `05_MOMENTO_DE_CONEXAO`
7. `06_NARRAMOS_JUNTOS`
8. `07_RITUAL_DE_FECHAMENTO`
9. `10_FORMACAO_DO_PORTADOR`
10. `08_CONEXAO_DA_JORNADA`
11. `09_SEMENTES_PARA_O_DIA`
12. `11_NAVEGACAO_INFERIOR`
...
1. Criar `ESQUELETO_GERAL_LICAO_SEMENTES.md`
2. Criar `PROTOCOLO_REVISAO_POR_LICAO.md`
3. Criar `RUBRICA_PREMIUM_REVISAO.md`
4. Criar `STATUS_REVISAO_SEMENTES.md`
5. Criar pasta `transversais/`
6. Criar pasta `topicos/`
7. Criar `TX07_EXCECAO_L000_PORTAL.md`
8. Criar `00_BASE_E_HERO.md`
9. Criar `01_HEADER_SUPERIOR.md`
10. Criar `02_PREPARACAO_DO_PORTADOR.md`
11. Criar `03_RITUAL_DE_ENTRADA.md`
12. Criar `04_A_JORNADA.md`
13. Criar `05_MOMENTO_DE_CONEXAO.md`
14. Criar `06_NARRAMOS_JUNTOS.md`
15. Criar `07_RITUAL_DE_FECHAMENTO.md`
16. Criar `08_CONEXAO_DA_JORNADA.md`
17. Criar `09_SEMENTES_PARA_O_DIA.md`
18. Criar `10_FORMACAO_DO_PORTADOR.md`
19. Criar `11_NAVEGACAO_INFERIOR.md`
...
1. criar o `ESQUELETO_GERAL_LICAO_SEMENTES.md` ja com as decisoes acima;
2. em seguida criar `PROTOCOLO_REVISAO_POR_LICAO.md`;
